...
import { Briefcase, Mail, FileText, LogOut, Sparkles, Menu, X, Users } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';

function TalentLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: '/talent/feed', label: 'Job Feed', icon: Sparkles },
    { href: '/talent/invitations', label: 'Invitations', icon: Mail },
